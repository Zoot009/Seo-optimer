  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const resetToken = encodeURIComponent(result.resetToken);
        setTimeout(() => {
          router.push(`/reset-password?email=${encodedEmail}&token=${resetToken}`);
        }, 2000);
      } else {
        ...
        <div className="flex-1 flex items-center justify-center px-8 pb-8">
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-500 mb-6 text-center">
              Please enter it below to continue with password reset.
            </p>

            {/* Success Message */}
            {success && (
              <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-md mb-6 text-center">
                <p className="font-semibold">Code Verified Successfully! ✓</p>
            ...
            <div className="text-center pt-6 space-y-2">
              ...
              <div>
                <Link href="/forgot-password" className="text-[#0D6EFD] hover:underline font-medium">
